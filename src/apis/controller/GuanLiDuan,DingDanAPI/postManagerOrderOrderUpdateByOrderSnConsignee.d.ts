...
import { type MemberAddressDto } from "../../interface";
/**
 * /manager/order/order/update/{orderSn}/consignee
 */
export declare function postManagerOrderOrderUpdateByOrderSnConsignee(params: PostManagerOrderOrderUpdateByOrderSnConsigneeParams, input?: MemberAddressDto, config?: AxiosRequestConfig): import("axios").AxiosPromise<{
    success: boolean;
    message: string;
    code: number;
    timestamp: number;
...
export interface PostManagerOrderOrderUpdateByOrderSnConsigneeParams {
    orderSn: string;
}
