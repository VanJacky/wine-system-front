 ...
 */
export declare function putManagerOrderOrderUpdateByOrderSnPrice(params: PutManagerOrderOrderUpdateByOrderSnPriceParams, config?: AxiosRequestConfig): import("axios").AxiosPromise<{
    success: boolean;
    message: string;
    code: number;
    timestamp: number;
...
export interface PutManagerOrderOrderUpdateByOrderSnPriceParams {
    orderSn: string;
    price: number;
}
