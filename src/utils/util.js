...
import {
  getManagerPermissionMenuMemberMenu
} from "@/apis/controller/GuanLiDuan,CaiDanGuanLiJieKou/getManagerPermissionMenuMemberMenu";
...
util.initRouter = function(vm) {
  ...
  if (!vm.$store.state.app.added) {
    // 第一次加载 读取数据
    // 加载菜单
    getManagerPermissionMenuMemberMenu().then(res => {
