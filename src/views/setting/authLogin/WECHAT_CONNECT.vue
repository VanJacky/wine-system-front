      ...
      <div class="col">
        <el-card :padding="0">
          ...
          <div>
            ...
            <el-divider orientation="left">登录设置</el-divider>
            <div class="pay-list">
              <el-form style="width:100%;" ref="formValidate" :model="formValidate" :rules="ruleValidate" label-width="80">
                <el-form-item label="appId" prop="appId">
                  <el-input @on-enter="setupSetting" class="label-appkey" v-model="item.appId" />
                </el-form-item>
                <el-form-item label="appSecret" prop="appSecret">
                  <el-input @on-enter="setupSetting" v-model="item.appSecret" />
                </el-form-item>
              </el-form>
...
export default {
  ...
  methods: {
    ...
    setupSetting() {
      setTimeout(() => {
          putManagerSettingPutByKey({key: this.type}, this.$util.urlFormat({
